  ...
  return (
    <div className="min-h-screen bg-ink font-body">
      ...
      <main className="max-w-3xl mx-auto px-8 py-12">
        <h1 className="font-display text-2xl text-white mb-1">Auto-suggested content</h1>
        ...
        {drafts?.length === 0 && (
          <p className="text-mist text-sm">
            Nothing here yet — this fills up once the weekly scan (Module 2) finds a gap
            and drafts something for it. See README "Module 2" to run it.
          </p>
        )}
